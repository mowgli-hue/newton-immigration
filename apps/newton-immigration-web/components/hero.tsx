    ...
    <section className="relative overflow-hidden bg-hero-gradient">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-20 sm:py-28">
        <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="max-w-3xl">
          ...
          <h1 className="text-4xl font-semibold leading-tight text-white sm:text-5xl">Your Trusted Pathway to Canada Immigration</h1>
          <p className="mt-5 text-base text-newton-dark/85 sm:text-lg">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <Link href="/crs-calculator" className="rounded-md border border-white/20 bg-white/10 px-5 py-3 text-sm font-semibold text-white transition hover:border-newton-red hover:text-newton-red">
              Calculate CRS Score
            </Link>
          </div>
        </motion.div>
